...
// So, as arguent to Observable.throw(AppErroObject)
...
// In this case not put the original error as well => We're not going to log this to the server => This is legitime error not an unexpected error

// Las stept => In our component
// Instead of working with the (error:Response) object => work with AppError or one of its derivities
// Because in post.service => throwind either AppError or NotFoundError
// So, in our component => Response should be AppError => And check if error is an instance of NotFoundError
