...
// Now that we have the currentUser property in auth.service.ts
// We can with this => display the name of current user on home page


// In home.component.html
// Replace Welcom[NAME] => with Welcome {{ authService.currentUser.name }}
// And use ngIf => To render only if user is logged in 
